...
### 🎤 Google Translate TTS (gTTS) - Free & Easy
...
4. **gTTS** - Google Translate TTS (free, no API key needed) ✨ NEW
...
- ✨ Added gTTS support - Free TTS with 25+ languages (no API key needed)
- 📥 Added direct video download button in web interface
- 🌐 Added multi-language support for UI (Vietnamese, English, Chinese, German, Portuguese)
- 🎤 Enhanced Chatterbox TTS integration with better audio quality
- 🎯 Improved semantic video matching with text similarity
